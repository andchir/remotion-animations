...
const Star = ({ x, y, angle, delay, seed }) => {
  ...
  const distance = progress * (296 + (0,esm.random)(seed + "-dist") * 148);
  const starX = x + Math.cos(angle) * distance;
  const starY = y + Math.sin(angle) * distance;
  const opacity = (0,esm.interpolate)(starFrame, [0, 5, 20, 35], [0, 1, 1, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const scale = (0,esm.interpolate)(starFrame, [0, 10, 30], [0.5, 1, 0.3], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const rotation = (0,esm.random)(seed + "-rot") * 360;
  const size = 60 + (0,esm.random)(seed + "-size") * 44;
  const colors = ["#FFD700", "#FF6B6B", "#4ECDC4", "#45B7D1", "#FFA07A", "#98D8C8", "#F7DC6F", "#BB8FCE"];
  const colorIndex = Math.floor((0,esm.random)(seed + "-color") * colors.length);
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: size, height: size, viewBox: "0 0 24 24", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "path",
        {
...
const ArrowCursor = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: "88", height: "88", viewBox: "0 0 24 24", fill: "none", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
  "path",
  {
...
const HandCursor = () => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { width: "118", height: "118", viewBox: "0 0 256 256", children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { children: [
...
const SubscribeButton = ({ clicked }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  let scale = 1;
  if (clicked && frame >= TIMING.CLICK_FRAME) {
    const clickProgress = (0,esm.spring)({
      fps,
    ...
    scale = (0,esm.interpolate)(clickProgress, [0, 1], [0.95, 1], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
    });
  }
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      style: {
        ...
        transition: clicked ? "background-color 0.1s" : void 0
      },
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "span",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(BellIcon, { shaking: clicked })
      ]
    }
  );
};
const SubscribeButtonAnimation = () => {
  const frame = (0,esm.useCurrentFrame)();
  ...
  const moveProgress = (0,esm.spring)({
    fps,
    frame,
    config: {
      damping: 50,
  ...
  const cursorX = (0,esm.interpolate)(
  ...
  const cursorY = (0,esm.interpolate)(
    Math.min(moveProgress, 1),
    [0, 1],
  ...
  if (frame >= TIMING.CLICK_FRAME && frame < TIMING.CLICK_FRAME + 5) {
    clickOffsetY = (0,esm.interpolate)(frame, [TIMING.CLICK_FRAME, TIMING.CLICK_FRAME + 2, TIMING.CLICK_FRAME + 5], [0, 11, 0], {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
    });
  }
  ...
  for (let i = 0; i < numStars; i++) {
    const angle = i / numStars * Math.PI * 2 + (0,esm.random)(`star-angle-${i}`) * 0.5;
    const delay = Math.floor((0,esm.random)(`star-delay-${i}`) * 5);
    stars.push(
      /* @__PURE__ */ (0,jsx_runtime.jsx)(
        Star,
        {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { backgroundColor: "transparent" }, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.AbsoluteFill,
      {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SubscribeButton, { clicked: isClicked })
      }
    ),
    isClicked && stars,
    /* @__PURE__ */ (0,jsx_runtime.jsx)(
      "div",
      {
        ...
        children: isHovering ? /* @__PURE__ */ (0,jsx_runtime.jsx)(HandCursor, {}) : /* @__PURE__ */ (0,jsx_runtime.jsx)(ArrowCursor, {})
      }
    )
  ] });
};

;// ./src/animations/text-animation-1/TextAnimation1.tsx



const TextAnimation1_TIMING = {
...
const SUBTITLE_TEXT_COLOR = "#FFD700";
...
const TextAnimation1 = () => {
  ...
  const entranceProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation1_TIMING.ENTRANCE_START, TextAnimation1_TIMING.ENTRANCE_START + TextAnimation1_TIMING.ENTRANCE_DURATION],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const exitProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation1_TIMING.EXIT_START, TextAnimation1_TIMING.EXIT_START + TextAnimation1_TIMING.EXIT_DURATION],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const floatOffset = (0,esm.interpolate)(
    frame,
    [TextAnimation1_TIMING.HOLD_START, TextAnimation1_TIMING.HOLD_START + TextAnimation1_TIMING.HOLD_DURATION],
    [0, 10],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const opacity = frame < TextAnimation1_TIMING.EXIT_START ? (0,esm.interpolate)(entranceProgress, [0, 0.3], [0, 1], { extrapolateRight: "clamp" }) : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0]);
  const translateY = frame < TextAnimation1_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [-200, 0]) : frame < TextAnimation1_TIMING.EXIT_START ? Math.sin((frame - TextAnimation1_TIMING.HOLD_START) / 15) * floatOffset : (0,esm.interpolate)(exitProgress, [0, 1], [0, 200]);
  const scale = frame < TextAnimation1_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [0.3, 1]) : frame < TextAnimation1_TIMING.EXIT_START ? 1 : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0.3]);
  const rotation = frame < TextAnimation1_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [180, 0]) : frame < TextAnimation1_TIMING.EXIT_START ? 0 : (0,esm.interpolate)(exitProgress, [0, 1], [0, -90]);
  const renderStaggeredText = (text, fontSize, color, isMain) => {
    return text.split("").map((char, index) => {
      const charDelay = index * 2;
      const charProgress = (0,esm.interpolate)(
        frame,
        [TextAnimation1_TIMING.ENTRANCE_START + charDelay, TextAnimation1_TIMING.ENTRANCE_START + charDelay + 20],
        [0, 1],
        {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
      ...
      const charOpacity = frame < TextAnimation1_TIMING.EXIT_START ? charProgress : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0]);
      const charScale = frame < TextAnimation1_TIMING.HOLD_START ? (0,esm.interpolate)(charProgress, [0, 1], [0, 1]) : frame < TextAnimation1_TIMING.EXIT_START ? 1 : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0.5]);
      const charTranslateY = frame < TextAnimation1_TIMING.HOLD_START ? (0,esm.interpolate)(charProgress, [0, 1], [50, 0]) : 0;
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "span",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                ...
                children: renderStaggeredText(MAIN_TEXT, FONT_SIZE_MAIN, MAIN_TEXT_COLOR, true)
              }
            ),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                ...
                children: renderStaggeredText(SUBTITLE_TEXT, FONT_SIZE_SUBTITLE, SUBTITLE_TEXT_COLOR, false)
              }
            )
          ]
        }
...
;// ./src/animations/text-animation-2/TextAnimation2.tsx



const TextAnimation2_TIMING = {
...
const TextAnimation2_MAIN_TEXT = "YOU TEXT HERE";
const TextAnimation2_SUBTITLE_TEXT = "Your caption here";
const TextAnimation2_MAIN_TEXT_COLOR = "#00F5FF";
const TextAnimation2_SUBTITLE_TEXT_COLOR = "#FF6B9D";
const GLOW_COLOR = "#00F5FF";
const GLOW_COLOR_SECONDARY = "#FF6B9D";
const TextAnimation2_FONT_SIZE_MAIN = 80;
const TextAnimation2_FONT_SIZE_SUBTITLE = 36;
const TextAnimation2_FONT_FAMILY = "Arial, Helvetica, sans-serif";
const TextAnimation2_FONT_WEIGHT_MAIN = "900";
const TextAnimation2_FONT_WEIGHT_SUBTITLE = "700";
const TextAnimation2 = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height } = (0,esm.useVideoConfig)();
  const entranceProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation2_TIMING.ENTRANCE_START, TextAnimation2_TIMING.ENTRANCE_START + TextAnimation2_TIMING.ENTRANCE_DURATION],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: esm.Easing.bezier(0.25, 0.1, 0.25, 1)
    }
  );
  const exitProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation2_TIMING.EXIT_START, TextAnimation2_TIMING.EXIT_START + TextAnimation2_TIMING.EXIT_DURATION],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: esm.Easing.in(esm.Easing.ease)
    }
  );
  const pulseIntensity = (0,esm.interpolate)(
    Math.sin((frame - TextAnimation2_TIMING.HOLD_START) / 10) * 0.5 + 0.5,
    [0, 1],
    [0.7, 1],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
  );
  const renderWaveText = (text, fontSize, color, glowColor, isMain) => {
    return text.split("").map((char, index) => {
      const charDelay = index * 3;
      const waveOffset = Math.sin(index * 0.5) * 20;
      const charEntranceProgress = (0,esm.interpolate)(
        frame,
        [
          TextAnimation2_TIMING.ENTRANCE_START + charDelay,
          TextAnimation2_TIMING.ENTRANCE_START + charDelay + 15
        ],
        [0, 1],
        {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
          easing: esm.Easing.out(esm.Easing.ease)
        }
      );
      const charOpacity = frame < TextAnimation2_TIMING.EXIT_START ? charEntranceProgress : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0]);
      const charTranslateX = frame < TextAnimation2_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceProgress, [0, 1], [-100, 0]) : frame < TextAnimation2_TIMING.EXIT_START ? 0 : (0,esm.interpolate)(exitProgress, [0, 1], [0, index % 2 === 0 ? 50 : -50]);
      const charTranslateY = frame < TextAnimation2_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceProgress, [0, 1], [waveOffset, 0]) : frame < TextAnimation2_TIMING.EXIT_START ? 0 : (0,esm.interpolate)(exitProgress, [0, 1], [0, 100]);
      const charScale = frame < TextAnimation2_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceProgress, [0, 1], [0.3, 1]) : frame < TextAnimation2_TIMING.EXIT_START ? 1 : (0,esm.interpolate)(exitProgress, [0, 1], [1, 1.5]);
      const charBlur = frame < TextAnimation2_TIMING.EXIT_START ? 0 : (0,esm.interpolate)(exitProgress, [0, 1], [0, 10]);
      const glowIntensity = frame >= TextAnimation2_TIMING.HOLD_START && frame < TextAnimation2_TIMING.EXIT_START ? pulseIntensity : charEntranceProgress;
      const textShadow = frame < TextAnimation2_TIMING.EXIT_START ? `
  ...
  const containerOpacity = frame < TextAnimation2_TIMING.ENTRANCE_START + 10 ? (0,esm.interpolate)(frame, [TextAnimation2_TIMING.ENTRANCE_START, TextAnimation2_TIMING.ENTRANCE_START + 10], [0, 1]) : frame < TextAnimation2_TIMING.EXIT_START + 20 ? 1 : (0,esm.interpolate)(frame, [TextAnimation2_TIMING.EXIT_START + 20, TextAnimation2_TIMING.EXIT_START + TextAnimation2_TIMING.EXIT_DURATION], [1, 0]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      style: {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              ...
              {
                style: {
                  fontFamily: TextAnimation2_FONT_FAMILY,
                  fontSize: `${TextAnimation2_FONT_SIZE_MAIN}px`,
                  fontWeight: TextAnimation2_FONT_WEIGHT_MAIN,
                  color: TextAnimation2_MAIN_TEXT_COLOR,
                  letterSpacing: "6px",
                  textAlign: "center",
                  textTransform: "uppercase"
                },
                children: renderWaveText(
                  TextAnimation2_MAIN_TEXT,
                  TextAnimation2_FONT_SIZE_MAIN,
                  TextAnimation2_MAIN_TEXT_COLOR,
                  GLOW_COLOR,
                  true
                )
              }
              ...
              "div",
              {
                style: {
                  width: (0,esm.interpolate)(
                    frame,
                    [TextAnimation2_TIMING.ENTRANCE_START + 30, TextAnimation2_TIMING.ENTRANCE_START + 50],
                    [0, 300],
                    {
                      extrapolateLeft: "clamp",
                      extrapolateRight: "clamp",
                  ...
                  boxShadow: frame >= TextAnimation2_TIMING.HOLD_START && frame < TextAnimation2_TIMING.EXIT_START ? `0 0 ${10 * pulseIntensity}px ${GLOW_COLOR}` : "0 0 5px rgba(0, 245, 255, 0.5)",
                  opacity: frame < TextAnimation2_TIMING.EXIT_START ? 1 : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0])
                }
              }
            ),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  fontFamily: TextAnimation2_FONT_FAMILY,
                  fontSize: `${TextAnimation2_FONT_SIZE_SUBTITLE}px`,
                  fontWeight: TextAnimation2_FONT_WEIGHT_SUBTITLE,
                  color: TextAnimation2_SUBTITLE_TEXT_COLOR,
                  letterSpacing: "3px",
                  textAlign: "center"
                },
                children: renderWaveText(
                  TextAnimation2_SUBTITLE_TEXT,
                  TextAnimation2_FONT_SIZE_SUBTITLE,
                  TextAnimation2_SUBTITLE_TEXT_COLOR,
...
;// ./src/animations/text-animation-3/TextAnimation3.tsx



const TextAnimation3_TIMING = {
...
const TextAnimation3_MAIN_TEXT = "YOU TEXT HERE";
const TextAnimation3_SUBTITLE_TEXT = "Your caption here";
const TextAnimation3_MAIN_TEXT_COLOR = "#E91E63";
const TextAnimation3_SUBTITLE_TEXT_COLOR = "#00BCD4";
const SHIMMER_COLOR_1 = "#E91E63";
const SHIMMER_COLOR_2 = "#9C27B0";
const SHIMMER_COLOR_3 = "#00BCD4";
const TextAnimation3_FONT_SIZE_MAIN = 84;
const TextAnimation3_FONT_SIZE_SUBTITLE = 38;
const TextAnimation3_FONT_FAMILY = "Arial, Helvetica, sans-serif";
const TextAnimation3_FONT_WEIGHT_MAIN = "900";
const TextAnimation3_FONT_WEIGHT_SUBTITLE = "700";
const PARTICLES_PER_CHAR = 5;
const TextAnimation3 = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const entranceSpring = (0,esm.spring)({
    frame: frame - TextAnimation3_TIMING.ENTRANCE_START,
    fps,
    config: {
      damping: 20,
      stiffness: 200
  ...
  const exitProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation3_TIMING.EXIT_START, TextAnimation3_TIMING.EXIT_START + TextAnimation3_TIMING.EXIT_DURATION],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
  ...
  const shimmerCycle = (0,esm.interpolate)(
    (frame - TextAnimation3_TIMING.HOLD_START) % 45,
    [0, 15, 30, 45],
    [0, 1, 2, 0],
    {
      extrapolateLeft: "clamp",
  ...
  const getShimmerColor = (baseColor, cycle) => {
    if (frame < TextAnimation3_TIMING.HOLD_START || frame >= TextAnimation3_TIMING.EXIT_START) {
      return baseColor;
    }
    if (cycle < 0.5) {
      return baseColor;
    } else if (cycle < 1.5) {
      return baseColor === TextAnimation3_MAIN_TEXT_COLOR ? SHIMMER_COLOR_2 : SHIMMER_COLOR_1;
    } else {
      return baseColor === TextAnimation3_MAIN_TEXT_COLOR ? SHIMMER_COLOR_3 : SHIMMER_COLOR_2;
    }
  };
  const renderParticleText = (text, fontSize, baseColor, isMain) => {
    return text.split("").map((char, charIndex) => {
      const charDelay = charIndex * 2;
      const charEntranceSpring = (0,esm.spring)({
        frame: frame - TextAnimation3_TIMING.ENTRANCE_START - charDelay,
        fps,
        config: {
          damping: 20,
          stiffness: 200
      ...
      const scatterAngle = charIndex * 137.5 % 360;
      ...
      const charTranslateX = frame < TextAnimation3_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceSpring, [0, 1], [scatterX, 0]) : 0;
      const charTranslateY = frame < TextAnimation3_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceSpring, [0, 1], [scatterY, 0]) : frame >= TextAnimation3_TIMING.EXIT_START ? (0,esm.interpolate)(exitProgress, [0, 1], [0, 200 + charIndex * 20]) : 0;
      const exitScatterX = frame >= TextAnimation3_TIMING.EXIT_START ? (0,esm.interpolate)(exitProgress, [0, 1], [0, scatterX * 0.5]) : 0;
      const charOpacity = frame < TextAnimation3_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceSpring, [0, 0.3, 1], [0, 0.5, 1]) : frame < TextAnimation3_TIMING.EXIT_START ? 1 : (0,esm.interpolate)(exitProgress, [0, 0.7, 1], [1, 0.3, 0]);
      const charScale = frame < TextAnimation3_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceSpring, [0, 1], [0.2, 1]) : frame >= TextAnimation3_TIMING.EXIT_START ? (0,esm.interpolate)(exitProgress, [0, 1], [1, 0.2]) : 1;
      const charRotation = frame < TextAnimation3_TIMING.HOLD_START ? (0,esm.interpolate)(charEntranceSpring, [0, 1], [360 + charIndex * 45, 0]) : frame >= TextAnimation3_TIMING.EXIT_START ? (0,esm.interpolate)(exitProgress, [0, 1], [0, -180 - charIndex * 30]) : 0;
      const charBlur = frame >= TextAnimation3_TIMING.EXIT_START ? (0,esm.interpolate)(exitProgress, [0.5, 1], [0, 8]) : 0;
      const currentColor = getShimmerColor(baseColor, shimmerCycle);
      const shimmerIntensity = frame >= TextAnimation3_TIMING.HOLD_START && frame < TextAnimation3_TIMING.EXIT_START ? (0,esm.interpolate)(
        Math.sin((frame - TextAnimation3_TIMING.HOLD_START + charIndex * 3) / 8 * Math.PI) * 0.5 + 0.5,
        [0, 1],
        [0.5, 1]
      ) : 0.5;
      const textShadow = frame >= TextAnimation3_TIMING.HOLD_START && frame < TextAnimation3_TIMING.EXIT_START ? `
  ...
  const containerOpacity = (0,esm.interpolate)(
    frame,
    [TextAnimation3_TIMING.ENTRANCE_START, TextAnimation3_TIMING.ENTRANCE_START + 10],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              ...
              {
                style: {
                  fontFamily: TextAnimation3_FONT_FAMILY,
                  fontSize: `${TextAnimation3_FONT_SIZE_MAIN}px`,
                  fontWeight: TextAnimation3_FONT_WEIGHT_MAIN,
                  letterSpacing: "5px",
                  textAlign: "center",
                  textTransform: "uppercase"
                },
                children: renderParticleText(TextAnimation3_MAIN_TEXT, TextAnimation3_FONT_SIZE_MAIN, TextAnimation3_MAIN_TEXT_COLOR, true)
              }
            ),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  fontFamily: TextAnimation3_FONT_FAMILY,
                  fontSize: `${TextAnimation3_FONT_SIZE_SUBTITLE}px`,
                  fontWeight: TextAnimation3_FONT_WEIGHT_SUBTITLE,
                  letterSpacing: "3px",
                  textAlign: "center"
                },
                children: renderParticleText(
                  TextAnimation3_SUBTITLE_TEXT,
                  TextAnimation3_FONT_SIZE_SUBTITLE,
                  TextAnimation3_SUBTITLE_TEXT_COLOR,
                  false
                )
              }
            )
...
;// ./src/animations/text-animation-4/TextAnimation4.tsx



const TextAnimation4_TIMING = {
  ENTRANCE_START: 0,
...
const TextAnimation4_MAIN_TEXT = "YOU TEXT HERE";
const TextAnimation4_SUBTITLE_TEXT = "Your caption here";
const COLORS = ["#6366F1", "#8B5CF6", "#EC4899", "#F59E0B", "#10B981"];
const TextAnimation4_FONT_FAMILY = "Arial, Helvetica, sans-serif";
const TextAnimation4_FONT_WEIGHT_MAIN = "900";
const TextAnimation4_FONT_WEIGHT_SUBTITLE = "600";
const TextAnimation4_FONT_SIZE_MAIN = 120;
const TextAnimation4_FONT_SIZE_SUBTITLE = 48;
...
const TextBox = ({
  ...
  const entranceProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation4_TIMING.ENTRANCE_START + delay, TextAnimation4_TIMING.ENTRANCE_START + delay + 50],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const exitProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation4_TIMING.EXIT_START + delay, TextAnimation4_TIMING.EXIT_START + delay + 40],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: esm.Easing.in(esm.Easing.exp)
    }
  );
  const exitAngles = [
    { x: 1800, y: 1200, rot: 180 },
    { x: -2e3, y: 1e3, rot: -180 },
    { x: 1500, y: -1e3, rot: 270 },
    { x: -1700, y: -900, rot: -270 },
    { x: 0, y: 1500, rot: 360 }
  ];
  const exitAngle = exitAngles[index % exitAngles.length];
  const translateX = frame < TextAnimation4_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [entryAngle.x, xPosition]) : frame < TextAnimation4_TIMING.EXIT_START ? xPosition : (0,esm.interpolate)(exitProgress, [0, 1], [xPosition, exitAngle.x]);
  const translateY = frame < TextAnimation4_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [entryAngle.y, 0]) : frame < TextAnimation4_TIMING.EXIT_START ? 0 : (0,esm.interpolate)(exitProgress, [0, 1], [0, exitAngle.y]);
  const rotation = frame < TextAnimation4_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [entryAngle.rot, 0]) : frame < TextAnimation4_TIMING.EXIT_START ? 0 : (0,esm.interpolate)(exitProgress, [0, 1], [0, exitAngle.rot]);
  const waveOffset = frame >= TextAnimation4_TIMING.HOLD_START && frame < TextAnimation4_TIMING.EXIT_START ? Math.sin((frame - TextAnimation4_TIMING.HOLD_START + index * 8) / 15) * 10 : 0;
  const waveRotation = frame >= TextAnimation4_TIMING.HOLD_START && frame < TextAnimation4_TIMING.EXIT_START ? Math.sin((frame - TextAnimation4_TIMING.HOLD_START + index * 10) / 20) * 2 : 0;
  const scale = frame < TextAnimation4_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 1], [0.2, 1]) : frame < TextAnimation4_TIMING.EXIT_START ? (0,esm.interpolate)(
    Math.sin((frame - TextAnimation4_TIMING.HOLD_START + index * 5) / 25),
    [-1, 1],
    [0.98, 1.02]
  ) : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0.3]);
  const opacity = frame < TextAnimation4_TIMING.HOLD_START ? (0,esm.interpolate)(entranceProgress, [0, 0.7, 1], [0, 0.8, 1]) : frame < TextAnimation4_TIMING.EXIT_START ? 1 : (0,esm.interpolate)(exitProgress, [0, 1], [1, 0]);
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsx)("clipPath", { id: uniqueId, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "text",
              {
                x: boxWidth / 2,
                y: boxHeight / 2,
                ...
                fontFamily: TextAnimation4_FONT_FAMILY,
                fontSize,
                fontWeight,
                children: text
              }
...
const TextAnimation4 = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const mainWords = TextAnimation4_MAIN_TEXT.split(" ");
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: (() => {
              const charWidth = TextAnimation4_FONT_SIZE_MAIN * 0.6;
              const wordGap = 25;
              ...
              return mainBoxes.map((box, idx) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
                TextBox,
                {
                  text: box.text,
                  fontSize: TextAnimation4_FONT_SIZE_MAIN,
                  fontWeight: TextAnimation4_FONT_WEIGHT_MAIN,
                  color: box.color,
                  frame,
                  index: box.index,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              TextBox,
              {
                text: TextAnimation4_SUBTITLE_TEXT,
                fontSize: TextAnimation4_FONT_SIZE_SUBTITLE,
                fontWeight: TextAnimation4_FONT_WEIGHT_SUBTITLE,
...
;// ./src/animations/text-animation-5/TextAnimation5.tsx



const TextAnimation5_TIMING = {
  ENTRANCE_START: 0,
  ENTRANCE_DURATION: 60,
  HOLD_START: 60,
  HOLD_DURATION: 60,
...
const TextAnimation5_MAIN_TEXT = "YOU TEXT HERE";
const TextAnimation5_SUBTITLE_TEXT = "Your caption here";
const TextAnimation5_COLORS = {
  primary: "#FF6B35",
  secondary: "#004E89",
  accent: "#1A936F",
  highlight: "#C6D8FF"
};
const TextAnimation5_FONT_FAMILY = "Arial, Helvetica, sans-serif";
const TextAnimation5_FONT_WEIGHT_MAIN = "900";
const TextAnimation5_FONT_WEIGHT_SUBTITLE = "600";
const TextAnimation5_FONT_SIZE_MAIN = 100;
const TextAnimation5_FONT_SIZE_SUBTITLE = 42;
const PADDING_X = 50;
const PADDING_Y = 25;
const TextBlock = ({
  text,
  ...
  const entranceProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation5_TIMING.ENTRANCE_START + staggerDelay, TextAnimation5_TIMING.ENTRANCE_START + staggerDelay + 45],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const exitProgress = (0,esm.interpolate)(
    frame,
    [TextAnimation5_TIMING.EXIT_START + staggerDelay, TextAnimation5_TIMING.EXIT_START + staggerDelay + 40],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: esm.Easing.in(esm.Easing.back(1.5))
    }
  );
  const isEntrance = frame < TextAnimation5_TIMING.HOLD_START;
  const isHold = frame >= TextAnimation5_TIMING.HOLD_START && frame < TextAnimation5_TIMING.EXIT_START;
  const isExit = frame >= TextAnimation5_TIMING.EXIT_START;
  const unfoldDirection = index % 2 === 0 ? 1 : -1;
  const entranceRotateY = isEntrance ? (0,esm.interpolate)(entranceProgress, [0, 1], [90 * unfoldDirection, 0]) : 0;
  const exitRotateY = isExit ? (0,esm.interpolate)(exitProgress, [0, 1], [0, -90 * unfoldDirection]) : 0;
  const holdWobble = isHold ? Math.sin((frame - TextAnimation5_TIMING.HOLD_START + index * 15) / 20) * 3 : 0;
  const holdFloat = isHold ? Math.sin((frame - TextAnimation5_TIMING.HOLD_START + index * 10) / 25) * 8 : 0;
  const entranceScale = isEntrance ? (0,esm.interpolate)(entranceProgress, [0, 1], [0.3, 1]) : 1;
  const exitScale = isExit ? (0,esm.interpolate)(exitProgress, [0, 1], [1, 0.3]) : entranceScale;
  const entranceOpacity = isEntrance ? (0,esm.interpolate)(entranceProgress, [0, 0.5, 1], [0, 0.7, 1]) : 1;
  const exitOpacity = isExit ? (0,esm.interpolate)(exitProgress, [0, 1], [1, 0]) : entranceOpacity;
  const slideDirection = index % 2 === 0 ? -1 : 1;
  const entranceSlideX = isEntrance ? (0,esm.interpolate)(entranceProgress, [0, 1], [200 * slideDirection, 0]) : 0;
  const exitSlideX = isExit ? (0,esm.interpolate)(exitProgress, [0, 1], [0, -200 * slideDirection]) : entranceSlideX;
        ...
        "svg",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("defs", { children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("clipPath", { id: clipId, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "text",
                {
                  x: blockWidth / 2,
                  y: blockHeight / 2,
                  textAnchor: "middle",
                  dominantBaseline: "central",
                  fontFamily: TextAnimation5_FONT_FAMILY,
                  fontSize,
                  fontWeight,
                  children: text
                }
              ) }),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("linearGradient", { id: `grad-${clipId}`, x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: backgroundColor }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: adjustBrightness(backgroundColor, -20) })
              ] })
            ] }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "rect",
...
const TextAnimation5 = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const mainWords = TextAnimation5_MAIN_TEXT.split(" ");
  const colorKeys = Object.keys(TextAnimation5_COLORS);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        "div",
        {
          ...
          children: [
            (() => {
              const estimatedCharWidth = TextAnimation5_FONT_SIZE_MAIN * 0.58;
              const wordGap = 25;
              ...
              return mainWords.map((word, wordIndex) => {
                ...
                const bgColor = TextAnimation5_COLORS[colorKeys[colorIndex]];
                return /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  TextBlock,
                  {
                    text: word,
                    fontSize: TextAnimation5_FONT_SIZE_MAIN,
                    fontWeight: TextAnimation5_FONT_WEIGHT_MAIN,
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              TextBlock,
              {
                text: TextAnimation5_SUBTITLE_TEXT,
                fontSize: TextAnimation5_FONT_SIZE_SUBTITLE,
                fontWeight: TextAnimation5_FONT_WEIGHT_SUBTITLE,
                backgroundColor: TextAnimation5_COLORS.accent,
                frame,
...
;// ./src/animations/lower-third-1/LowerThird1.tsx



const LowerThird1_TIMING = {
...
const LowerThird1_FONT_FAMILY = "Arial, Helvetica, sans-serif";
...
const LowerThird1 = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { width, height } = (0,esm.useVideoConfig)();
  const containerSlideX = (0,esm.interpolate)(
    frame,
    [LowerThird1_TIMING.ENTRANCE_START, LowerThird1_TIMING.ENTRANCE_START + LowerThird1_TIMING.ENTRANCE_DURATION],
    [-400, 0],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const containerOpacity = (0,esm.interpolate)(
    frame,
    [LowerThird1_TIMING.ENTRANCE_START, LowerThird1_TIMING.ENTRANCE_START + 15],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp"
  ...
  const underlineProgress = (0,esm.interpolate)(
    frame,
    [LowerThird1_TIMING.ENTRANCE_START + 20, LowerThird1_TIMING.ENTRANCE_START + LowerThird1_TIMING.ENTRANCE_DURATION],
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const shimmerOffset = (0,esm.interpolate)(
    (frame - LowerThird1_TIMING.HOLD_START) % 60,
    [0, 60],
    [-100, 200],
    {
      extrapolateLeft: "clamp",
  ...
  const pulseIntensity = (0,esm.interpolate)(
    Math.sin((frame - LowerThird1_TIMING.HOLD_START) / 30),
    [-1, 1],
    [0.85, 1],
    {
      extrapolateLeft: "clamp",
  ...
  const exitOpacity = (0,esm.interpolate)(
    frame,
    [LowerThird1_TIMING.EXIT_START, LowerThird1_TIMING.EXIT_START + LowerThird1_TIMING.EXIT_DURATION],
    [1, 0],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
  ...
  const exitSlideX = (0,esm.interpolate)(
    frame,
    [LowerThird1_TIMING.EXIT_START, LowerThird1_TIMING.EXIT_START + LowerThird1_TIMING.EXIT_DURATION],
    [0, 300],
    {
  ...
  const isInEntrance = frame < LowerThird1_TIMING.HOLD_START;
  const isInHold = frame >= LowerThird1_TIMING.HOLD_START && frame < LowerThird1_TIMING.EXIT_START;
  const isInExit = frame >= LowerThird1_TIMING.EXIT_START;
  const finalTranslateX = isInEntrance ? containerSlideX : isInExit ? exitSlideX : 0;
  const finalOpacity = isInEntrance ? containerOpacity : isInExit ? exitOpacity : 1;
  const renderStaggeredText = (text, fontSize, fontWeight, color, baseDelay) => {
    return text.split("").map((char, index) => {
      ...
      const charTranslateY = isInEntrance ? (0,esm.interpolate)(charProgress, [0, 1], [20, 0]) : 0;
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "span",
        {
          style: {
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...
                  right: -20,
                  bottom: -20,
                  background: `linear-gradient(90deg, ${LowerThird1_COLORS.backgroundOverlay} 0%, rgba(0, 0, 0, 0.4) 70%, transparent 100%)`,
                  borderRadius: "8px",
                  zIndex: -1
                }
              }
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              ...
              {
                style: {
                  fontFamily: LowerThird1_FONT_FAMILY,
                  fontSize: `${FONT_SIZE_PRIMARY}px`,
                  fontWeight: FONT_WEIGHT_PRIMARY,
                  color: LowerThird1_COLORS.primary,
                  letterSpacing: "2px",
                  lineHeight: 1.2,
                  textTransform: "uppercase",
                  textShadow: `
            ...
            `
                ...
                children: renderStaggeredText(
                  PRIMARY_TEXT,
                  FONT_SIZE_PRIMARY,
                  FONT_WEIGHT_PRIMARY,
                  LowerThird1_COLORS.primary,
                  LowerThird1_TIMING.ENTRANCE_START + 10
                )
              }
            ),
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...
                  background: `linear-gradient(90deg, ${LowerThird1_COLORS.accentGradientStart} 0%, ${LowerThird1_COLORS.accentGradientEnd} 100%)`,
                  borderRadius: "2px",
                  position: "relative",
                  overflow: "hidden",
                  boxShadow: isInHold ? `0 0 ${15 * pulseIntensity}px ${LowerThird1_COLORS.accent}` : `0 0 10px ${LowerThird1_COLORS.accent}`
                },
                children: isInHold && /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
                      position: "absolute",
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  ...
                  color: LowerThird1_COLORS.secondary,
                  letterSpacing: "1px",
                  lineHeight: 1.3,
                  opacity: (0,esm.interpolate)(
                    frame,
                    [LowerThird1_TIMING.ENTRANCE_START + 25, LowerThird1_TIMING.ENTRANCE_START + 40],
                    [0, 1],
                    {
                      extrapolateLeft: "clamp",
                      extrapolateRight: "clamp"
                  ...
                  transform: `translateY(${isInEntrance ? (0,esm.interpolate)(
                    frame,
                    [LowerThird1_TIMING.ENTRANCE_START + 25, LowerThird1_TIMING.ENTRANCE_START + 40],
                    [15, 0],
                    {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "remotion-animations:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkremotion_animations"] = self["webpackChunkremotion_animations"] || [];
